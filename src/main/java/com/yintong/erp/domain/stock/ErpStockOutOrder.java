...
public class ErpStockOutOrder extends BaseEntityWithBarCode {
    @Id @GeneratedValue
    private Long id;
    ...
    @Column(columnDefinition = "bigint(20) comment '出库实际原材料id列表'")
    ...
    @Transient
    private String placeNames;//仓位列表，由于仓位和物料的弱关联，所以不入库
