...
@Builder
@Entity
public class ErpEndProductSupplier extends BaseEntityWithBarCode{
    @Id
    @GeneratedValue
    private Long id;
    @BarCode(excludeId = true)//4位
    @Column(columnDefinition = "varchar(40) comment '成品类型'")
    private String endProductType;
    @BarCodeIndex(1)
    @Column(columnDefinition = "bigint(20) comment '成品表id'")
