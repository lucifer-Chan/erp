...
(function ($, window, document) {
    ...
    methods.init = function (settings) {
        ...
        return this.each(function () {
            ...
            if (data.id) {
                ...
                data.label     = $original.text().replace(/\</g,'&lt;').replace(/\>/g,'&gt;').replace(/\"/g,'&quot;').replace(/\'/g,'&#39;');
    ...
    function _updateFields(option, $dk, reset) {
       ...
       // label = option.text().replace(/\</g,'&lt;').replace(/\>/g,'&gt;').replace(/\"/g,'&quot;').replace(/\'/g,'&#39;');
        label = option.text();
        data  = $dk.data('dropkick');
    ...
    function _build (tpl, view) {
        ...
        if (view.options && view.options.length) {
            for (var i = 0, l = view.options.length; i < l; i++) {
                ...
                oTemplate = oTemplate.replace('{{ text }}', $option.text().replace(/\</g,'&lt;').replace(/\>/g,'&gt;').replace(/\"/g,'&quot;').replace(/\'/g,'&#39;'));
